    ...
    <div className="flex h-full flex-col gap-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-lg font-['Cabinet_Grotesk'] text-[var(--text-primary)]">Operations</p>
        </div>
      </div>
      ...
      <div className="mt-auto rounded-2xl border border-[var(--border)] bg-white/90 p-4 shadow-[var(--shadow-soft)]">
        ...
        <p className="mt-2 text-lg font-['Cabinet_Grotesk'] text-[var(--text-primary)]">Systems nominal</p>
